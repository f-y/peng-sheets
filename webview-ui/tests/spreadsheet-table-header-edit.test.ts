...
describe("SpreadsheetTable Header Edit", () => {
    it("Enters edit mode on empty header double click", async () => {
        ...
        const emptyHeaderSpan = el.shadowRoot!.querySelector('.cell.header-col[data-col="1"] .cell-content') as HTMLElement;
        ...
        expect(el.selectedCol).toBe(1);
        expect(el.selectedRow).toBe(-1);
